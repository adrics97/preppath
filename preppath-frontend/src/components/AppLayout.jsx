    ...
    return (
        <div className={`flex h-screen overflow-hidden ${dark ? 'dark' : ''}`}>
            <div className="flex h-full w-full overflow-hidden bg-gray-50 dark:bg-gray-900">
                ...
                `}>
                    {/* Logo */}
                    <div className="h-14 flex items-center px-5 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
                        <span
                    ...
                    <header className="h-14 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-4 flex-shrink-0">
                        ...
                        <div className="relative" ref={userMenuRef}>
                            <button
                                ...
                                className="flex items-center gap-2.5 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg px-2 py-1.5 transition"
                            >
                            ...
                            {showUserMenu && (
                                <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-50">
                                    ...
                                    <button
                                        ...
                                        className="w-full text-left px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center gap-3 transition"
                                    >
                                    ...
                                    <div className="border-t border-gray-100 dark:border-gray-700 mt-1 pt-1">
                                        <button
                                            ...
                                            className="w-full text-left px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 flex items-center gap-3 transition"
                                        >
