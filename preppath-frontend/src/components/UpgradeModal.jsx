    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">{message.title}</h2>
                <p className="text-gray-600 dark:text-gray-400 mb-6">{message.description}</p>

                {/* Pro benefits */}
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-6 text-left">
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-3">With the Pro plan you get:</h3>
                    ...
                    <p className="text-center mt-4">
                        Only <span className="text-2xl font-bold text-blue-600 dark:text-blue-400">$9</span>
