                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="mt-6 flex space-x-4">
                            <a
                                href="https://github.com/adrics97/preppath"
                                target="_blank"
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a href="https://github.com/adrics97/preppath" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-white transition-colors">
                                    Documentation
                                </a>
                            </li>
                            <li>
